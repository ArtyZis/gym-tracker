    ...
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          ...
          // ยังต้องกัน /me/ ไว้เหมือนเดิม แม้เลิก deploy รุ่นส่วนตัวตรงนั้นแล้ว (15 ส.ค. 2026)
          // เหตุผลเปลี่ยนไปเป็นคนละเรื่อง: ตอนนี้ /me/ เป็นหน้าเปลี่ยนทางเปล่าๆ (ดู deploy.yml)
          // ถ้าปล่อยให้ SW เอา index.html มาเสิร์ฟทับ asset ที่เป็น relative จะไปหา
          // /me/assets/... ซึ่งไม่มี = หน้าขาว · กันไว้แล้วหน้าเปลี่ยนทางจึงทำงานจริง

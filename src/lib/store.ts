...
export interface Profile {
  ...
  // เลิกใช้แล้ว (16 ส.ค. 2026) — ปุ่มเลือกถูกเอาออกเพราะไม่มีโค้ดไหนอ่านค่านี้เลย
  // **ห้ามลบฟิลด์** ผู้ใช้จริงมีค่านี้เก็บอยู่ในเครื่อง ลบแล้วข้อมูลเก่าเสียหาย (กฎเหล็กข้อ 1)
  goal?: Goal;

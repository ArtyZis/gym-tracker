...
/**
 * ช่องทางซื้อ — ⚠️ ยังว่างอยู่ = ลูกค้าที่อยากจ่ายเงินไม่มีทางติดต่อได้เลย
 *
 * ใส่ค่าเดียวตรงนี้แล้วปุ่ม "ทักไลน์เพื่อขอรหัส" จะโผล่ในการ์ดขายเอง
 * รูปแบบที่รองรับ (ตัวแปลงอยู่ที่ lib/contact.ts):
 *   "artyz_z"                    ไลน์ไอดีส่วนตัว
 *   "@rankforge"                 บัญชีทางการไลน์
 *   "https://facebook.com/..."   ลิงก์อะไรก็ได้
 *   "0812345678"                 เบอร์โทร
 * ว่างไว้ = ไม่โชว์ปุ่ม (ดีกว่าโชว์ปุ่มที่กดแล้วไม่ไปไหน)
 */
